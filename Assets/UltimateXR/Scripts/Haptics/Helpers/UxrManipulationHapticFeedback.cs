...
namespace UltimateXR.Haptics.Helpers
{
    ...
    public class UxrManipulationHapticFeedback : UxrGrabbableObjectComponent<UxrManipulationHapticFeedback>
    {
        ...
        public int HapticClipOnGrab_audioSource { get; private set; }
        ...
        protected override void OnObjectGrabbed(UxrManipulationEventArgs e)
        {
            ...
            HapticClipOnGrab._audioSource = GetComponent<AudioSource>();
            HapticClipOnGrab._audioSource.PlayOneShot(HapticClipOnGrab._nameofAudio, 1);
            HapticClipOnGrab.ui.SetActive(true);
        ...
        protected override void OnObjectPlaced(UxrManipulationEventArgs e)
        {
            ...
            HapticClipOnGrab.ui.SetActive(false);
