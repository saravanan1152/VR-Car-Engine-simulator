...
public class Enginei4 : MonoBehaviour {
	...
	void Update () {
		...
		Piston1Delta = Rod1DefPos.z - transform.InverseTransformPoint (elements.Rod1.transform.position).z;
		...
		Piston4Delta = Rod4DefPos.z - transform.InverseTransformPoint (elements.Rod4.transform.position).z;

		elements.Piston1.transform.localPosition = Piston1DefPos + new Vector3 (0,0, Piston2Delta);
		elements.Piston2.transform.localPosition = Piston2DefPos - new Vector3 (0,0, Piston2Delta);
		elements.Piston3.transform.localPosition = Piston3DefPos - new Vector3 (0,0, Piston3Delta);
		elements.Piston4.transform.localPosition = Piston4DefPos + new Vector3 (0,0, Piston2Delta);
